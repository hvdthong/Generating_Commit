...
def read_args():
    ...
    # Number of parameters for reformatting commits -- (commit code: baseline)
    parser.add_argument('-title_length', type=int, default=24, help='the length of the title of the commit message')
    parser.add_argument('-diffcode_length', type=int, default=512, help='the length of the diffcode of the commit code')
    # Number of parameters for reformatting commit code
